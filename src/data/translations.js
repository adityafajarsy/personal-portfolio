...
export const translations = {
  en: {
    ...
    home: {
      ...
      bio: `With a background in language, graphic design, and software engineering, I like working across the whole product, from understanding the problem and designing the experience to building the final interface.`,
...
`,
  ...
  id: {
    ...
    home: {
      ...
      quote: "I start with real problems...",
      title: "Hi, I'm Aditya Fajar SY",
      bio: "Berawal dari dunia design, lalu mendalami UI/UX dan berkembang ke software engineering. Sekarang, saya memakai ketiganya untuk membangun aplikasi, mulai dari memahami struktur masalah hingga mewujudkannya menjadi produk yang bisa digunakan.",
      downloadCv: "Download CV",
      connectMe: "Connect with me",
    },
    projects: {
